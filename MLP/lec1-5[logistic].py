...
for k in range(3, 11):
    ...
    print("k :", k, "\nss: ", silhouette_score(X_scale, kmeans_k.labels_, metric='euclidean'))
...
plt.show()
# =================================================================================== #
3's siloutte score:  0.36750122734074775
4's siloutte score:  0.35928000330970944
5's siloutte score:  0.3008870772654808
6's siloutte score:  0.19980466583435924
7's siloutte score:  0.20134420693634117
8's siloutte score:  0.19826053985825842
9's siloutte score:  0.27614450251969513
10's siloutte score:  0.20666770959115757
...
KNN - <classification matrics>
           ...
           F       0.84      0.96      0.90      6632
           M       0.58      0.24      0.34      1551

   micro avg       0.82      0.82      0.82      8183
   macro avg       0.71      0.60      0.62      8183
weighted avg       0.79      0.82      0.79      8183
